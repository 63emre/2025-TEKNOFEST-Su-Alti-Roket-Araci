...
# -*- coding: utf-8 -*-
"""
PITCH SAHA TESTİ (yalnızca UP & DOWN)
- Pixhawk'ı elle pitch ekseninde (burun yukarı/aşağı) çevirerek test.
- Beklenti (arkadan bakış): +pitch (burun yukarı) -> UP ↑, DOWN ↓
- LEFT/RIGHT nötr.
"""
...
SERVO_UP    = 14   # test
SERVO_DOWN  = 11   # test
SERVO_RIGHT = 12   # nötrde
SERVO_LEFT  = 13   # nötrde
...
# Kazanç ve sınırlar
K_ANG_US_PER_RAD = 700.0   # pitch (rad) -> mikro-saniye; sahada 300–700 deneyin
...
def main():
    ...
    # LEFT/RIGHT nötrde dursun
    set_servo(m, SERVO_LEFT,  PWM_NEU)
    set_servo(m, SERVO_RIGHT, PWM_NEU)
