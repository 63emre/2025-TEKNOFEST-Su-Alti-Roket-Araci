#!/usr/bin/env python3
"""
TEKNOFEST Su Altı Roket Aracı - AUX3 Servo Test
Basit servo döndürme testi - 330Hz frekans ayarlı
Pixhawk AUX OUT 3 servo motor kontrolü ve test
"""
...
# AUX3 servo kanal (Pixhawk AUX OUT 3 = Servo channel 11)
SERVO_CHANNEL = 11
...
class AUX3ServoTest:
    ...
    def set_servo_pwm(self, pwm_value):
        ...
        try:
            ...
            self.master.mav.command_long_send(
                ...
                0,
                SERVO_CHANNEL,  # AUX3 = Servo channel 11
                pwm_value,      # PWM value
                0, 0, 0, 0, 0
            )
            
            print(f"📍 AUX3 Servo: {pwm_value}µs")
            return True
    ...
    def run_all_tests(self):
        ...
        print("🧪 AUX3 SERVO TAM TEST PAKETİ")
        print("=" * 50)
        ...
        try:
            ...
            print("\n🎉 TÜM AUX3 SERVO TESTLERİ BAŞARILI!")
            return True
...
def main():
    """Ana fonksiyon"""
    servo_test = AUX3ServoTest()
    
    print(f"🚀 TEKNOFEST AUX3 Servo Test - Frekans: {SERVO_FREQUENCY}Hz")
    print("=" * 60)
    print("AUX3 Servo Test Menüsü:")
