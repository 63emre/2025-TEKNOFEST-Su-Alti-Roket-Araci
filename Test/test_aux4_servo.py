#!/usr/bin/env python3
"""
TEKNOFEST Su Altı Roket Aracı - AUX4 Servo Test
Basit servo döndürme testi - 330Hz frekans ayarlı
Pixhawk AUX OUT 4 servo motor kontrolü ve test
"""
...
class AUX4ServoTest:
    ...
    def set_servo_pwm(self, pwm_value):
        ...
        try:
            ...
            print(f"📍 AUX4 Servo: {pwm_value}µs")
            return True
    ...
    def run_all_tests(self):
        ...
        print("🧪 AUX4 SERVO TAM TEST PAKETİ")
        print("=" * 50)
        ...
        try:
            ...
            print("\n🎉 TÜM AUX4 SERVO TESTLERİ BAŞARILI!")
            return True
...
def main():
    """Ana fonksiyon"""
    servo_test = AUX4ServoTest()
    
    print(f"🚀 TEKNOFEST AUX4 Servo Test - Frekans: {SERVO_FREQUENCY}Hz")
    print("=" * 60)
    print("AUX4 Servo Test Menüsü:")
