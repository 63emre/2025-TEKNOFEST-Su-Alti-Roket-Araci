#!/usr/bin/env python3
"""
TEKNOFEST Su Altı Roket Aracı - AUX2 Servo Test
Basit servo döndürme testi - 330Hz frekans ayarlı
Pixhawk AUX OUT 2 servo motor kontrolü ve test
"""
...
# AUX2 servo kanal (Pixhawk AUX OUT 2 = Servo channel 10)
SERVO_CHANNEL = 10
...
class AUX2ServoTest:
    ...
    def set_servo_pwm(self, pwm_value):
        ...
        try:
            ...
            self.master.mav.command_long_send(
                ...
                0,
                SERVO_CHANNEL,  # AUX2 = Servo channel 10
                pwm_value,      # PWM value
                0, 0, 0, 0, 0
            )
            
            print(f"📍 AUX2 Servo: {pwm_value}µs")
            return True
    ...
    def run_all_tests(self):
        ...
        print("🧪 AUX2 SERVO TAM TEST PAKETİ")
        print("=" * 50)
        ...
        try:
            ...
            print("\n🎉 TÜM AUX2 SERVO TESTLERİ BAŞARILI!")
            return True
...
def main():
    """Ana fonksiyon"""
    servo_test = AUX2ServoTest()
    
    print(f"🚀 TEKNOFEST AUX2 Servo Test - Frekans: {SERVO_FREQUENCY}Hz")
    print("=" * 60)
    print("AUX2 Servo Test Menüsü:")
